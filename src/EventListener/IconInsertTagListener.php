...
class IconInsertTagListener
{
  ...
  private function getReplacement(string $iconTarget)
  {
    $icons = [
      ...
      'arrowUp' => '<path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5L12 3m0 0l7.5 7.5M12 3v18" />',
      'chevronDown' => '<path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />',
